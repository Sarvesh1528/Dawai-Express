class Mail:
    regularMsg = {
                                ...
                                <tr>
                                    <td style="text-align:left;">
                                        <div
                                            ...
                                            <h1 style="text-align:center; color: blue;">Dawai Express</h1>
                                            <p style="text-align : center; font-size: 1.1rem; font-weight:bold;line-height: 1.5;">
                                            Hello our beloved patient has taken {quantity} and is in good hands 👩🏻‍⚕️❤️!
                                            </p>
                                            <p style="text-align: center;">We regularly notify Parents/Guardians the updates of our beloved patients ❤️</p>
                                            <p style="text-align: center;">This is a system generated mail, please do not reply</p>
                                            <p style="text-align: center;">If you have suggestions, <a href="#" style="text-decoration: none;">let us know</a></p>
                                        </div>
                                    </td>
                                </tr>
                            </tbody>
                            ...
                            <tfoot class="email-footer" style="text-align:center; font-weight:normal;">
                                <tr>
                                    <td style="padding-top:32px;">
                                        ...
                                        <small style="font-size:12px; color:#999;">© Dawai Express 2026 All rights reserved<small>
                                    </td>
                                </tr>
                            </tfoot>
                        </table>
        ...
        ''',
        "subject" : "Status of our patient {name}"
    }
